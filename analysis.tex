...
\begin{figure}[!htb]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{figures/pid_mass2_pip2.pdf} \\
    \caption{$M^2$ for the selected $\pi^+$ tracks. In red is shown the PDG value for $M_{\pi^+}^2=0.01948 GeV^2$}
    \label{fig:mass2_pip}
  \end{center}
\end{figure}
