...
\section{G vs \texorpdfstring{$E_{CMS}$}{E-CMS} for different \texorpdfstring{$cos(\theta)$}{cos(theta)} bins and different Target polarization}
\label{app:G_TGPOL}
The value of G is extracted independently from different target polarizations (positive (GREEN)  and negative (BLUE) ). Results are compared in order to investigate possible systematic difference between the two sets. Here are plotted vs $E_{CMS}$(W) for different $cos(\theta_{CM})$ bins. \begin{figure}[htb]
  \begin{center}
    \subfloat[][ $ -0.94 \leq cos(\theta_{CM})<-0.8$ ] {
...
\ContinuedFloat
  \begin{center} 
    ...
    \subfloat[][ $ 0.8 \leq cos(\theta_{CM})<0.95$ ] {
...
\begin{figure}[htb]
  \begin{center}
    \subfloat[][ $ -0.94 \leq cos(\theta_{CM})<-0.8$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_0.png} 
      \label{fig:GvsW_SIGMA_exp_theta1}
    }
    \subfloat[][ $ -0.8 \leq cos(\theta_{CM})<-0.6$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_1.png}
    \label{fig:GvsW_SIGMA_exp_theta2}
    } \\
    \subfloat[][ $ -0.6 \leq cos(\theta_{CM})<-0.4$ ] {
    \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_2.png}
    \label{fig:GvsW_SIGMA_exp_theta3}
    }
    \subfloat[][ $ -0.4 \leq cos(\theta_{CM})<-0.2$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_3.png}
      \label{fig:GvsW_SIGMA_exp_theta4}
    }
  \end{center}
\end{figure}
\begin{figure}[htb]
\ContinuedFloat
  \begin{center} 
    \subfloat[][ $ -0.2 \leq cos(\theta_{CM})<0.0$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_4.png}
      \label{fig:GvsW_SIGMA_exp_theta5}
    }
    \subfloat[][ $ 0.0 \leq cos(\theta_{CM})<0.2$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_5.png}
      \label{fig:GvsW_SIGMA_exp_theta6}
    } \\    
    \subfloat[][ $ 0.2 \leq cos(\theta_{CM})<0.4$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_6.png}
      \label{fig:GvsW_SIGMA_exp_theta7}
    }
    \subfloat[][ $ 0.4 \leq cos(\theta_{CM})<0.6$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_7.png}
      \label{fig:GvsW_SIGMA_exp_theta8}
    }
  \end{center}
\end{figure}
\begin{figure}[htb]
\ContinuedFloat
  \begin{center} 
    \subfloat[][ $ 0.6 \leq cos(\theta_{CM})<0.8$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_8.png}
      \label{fig:GvsW_SIGMA_exp_theta9}
    }
    \subfloat[][ $ 0.8 \leq cos(\theta_{CM})<0.95$ ] {
      \includegraphics[height=0.40\textwidth]{figures/G_plots/comp_SIGMA_exp_system_9.png}
      \label{fig:GvsW_SIGMA_exp_theta10}
    }
  \end{center}
\end{figure}
...
\section{Target polarization vs \texorpdfstring{$E_{CMS}$}{E-CMS} for different \texorpdfstring{$cos(\theta)$}{cos(theta)} bins and different Target polarization}
\label{app:tgpol}
Target polarization is plotted vs $E_{CMS}$(W) for different $cos(\theta_{CM})$ bins. The different Target polarizations for each W and $cos(\theta)$ bin analyzed are plotted as the colored markers. Negative polarization data is shown in blue and positive polarization in green. The shaded areas represent the different coherent edge settings in the experiment. 
\begin{figure}[htb]
  \begin{center}
    \subfloat[][ $ -0.94 \leq cos(\theta_{CM})<-0.8$ ] {
...
\section{Systematic Correction for G as a function of the estracted values of G and \texorpdfstring{$\Sigma$}{Sigma}}
\label{app:G_syscorr}
...
\FloatBarrier
\newpage
\section{Systematic Correction for \texorpdfstring{$\Sigma$}{Sigma} as a function of the estracted values of G and \texorpdfstring{$\Sigma$}{Sigma}}
