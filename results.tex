...
In the following plots the black error bars shows the calculated error (staistical and systematic added in quadrature). The red error bar additionally includes the effect where the restriction of only keeping photons with polarization above 50\% is relaxed (as described in section \ref{sec:ph_pol_sys})
