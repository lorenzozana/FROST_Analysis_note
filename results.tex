...
In the following plots, as described in chapter \ref{sec:ph_pol_sys}, for each data point, in red is shown the possible fluctuation of varying the limit of 50\% for the photon polarization. 
